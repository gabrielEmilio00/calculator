...
var result = document.getElementById('result'); // result button
...
for (var i=0; i<number.length; i++) {
    number[i].addEventListener("click", function(e) {
        ...
        //if result isn't diplayed, keep adding
        if(resultDisplayed === false) {
            ...
            //we need clear the input string and add the new input to start the new operator
            resultDisplayed = false;
            input.innerHTML = '';
            input.innerHTML += e.target.innerHTML;
        }
